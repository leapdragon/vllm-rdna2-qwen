...
def fam(n):
    ...
    # 2026-09-26: fork kernels that used to land in "other"
    if n.startswith("_w8a8_kernel"): return "dense-int8-GEMM"
    if "rdna_ar_" in n: return "rdna-allreduce"
    if n.startswith(("_quant_rows", "_quant_pack", "_sum_requant", "_dequant")): return "int8-quant"
    if n.startswith(("chunk_fwd_kernel_o", "recompute_w_u", "chunk_scaled_dot_kkt", "merge_16x16", "_causal_conv1d", "solve_tril")): return "GDN"
    ...
    if "topkGating" in n or "moe_align" in n or "moe_sum" in n or "topk" in n.lower() or "act_and_mul" in n: return "MoE-glue"
